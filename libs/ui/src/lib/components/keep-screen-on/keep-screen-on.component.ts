...
@Component({
  ...
  imports: [AsyncPipe],
  templateUrl: './keep-screen-on.component.html',
  styleUrl: './keep-screen-on.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class KeepScreenOnComponent implements OnInit {
  public disabled = input<Observable<boolean>>(of(true));
  protected readonly mp4Data =
  ...
  private noSleepVideo = viewChild<ElementRef<HTMLVideoElement>>('video');
  private destroyRef = inject(DestroyRef);

  ngOnInit(): void {
    merge(fromEvent(document, 'click'), fromEvent(document, 'touchend'))
      .pipe(
      ...
      .subscribe(() => {
        this.noSleepVideo()?.nativeElement.play();
        log('Nosleep video started');
      });
